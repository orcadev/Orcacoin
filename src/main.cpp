...
// Copyright (c) 2014 Orcacoin developers
...
uint256 hashGenesisBlock("0xfac4392b6ee60be7dfa460a84393665341610d7dcd192f756f443e00df3441aa");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Orcacoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Orcacoin Signed Message:\n";
...
{
    // Orcacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Orcacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

int nTargetTimespan = 1 * 24 * 60 * 60; // 1 day
static const int nTargetSpacing = 120; // 2 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Orcacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Orcacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool ProcessBlock(CValidationState &state, CNode* pfrom, CBlock* pblock, CDiskBlockPos *dbp)
{
    ...
    if (pcheckpoint && pblock->hashPrevBlock != hashBestChain)
    {
        ...
        // across the hard forks for Orcacoin in particular
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfac4392b6ee60be7dfa460a84393665341610d7dcd192f756f443e00df3441aa");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "yucoin created 19 December 2013 1556";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387468560;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 385339217;
        ...
        assert(block.hashMerkleRoot == uint256("0x45806043a19e0424719ba2a3020a00dfbccedd20668eaae337653e57b4c98781"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Orcacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OrcacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OrcacoinMiner : ProcessBlock, block not accepted");
    }
